...
#define GETZ //In GPS.h, battery.h, debuglogger.h, engine_port.h, io.h, logger.h. Also need to change .pro file
...
private slots:
    ...
    void initial_charge(BatteryData batteryData);
    ...
    void on_pushButton_playPause();
    void setupMediaTable();
    void addMedia();
    void removeMedia();
    void removeAllMedia();
    ...
    void graphEfficiency(QCustomPlot *customPlot);
    void saveEfficiency();
    QStringList readEfficiency();

    void on_saveGraph();
    QStringList on_readGraph();

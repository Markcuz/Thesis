...
function configureandmakeqtbase {
	...
	CONFIGURE_OPTIONS="-v -opengl es2 -device linux-rasp-pi-g++ -device-option CROSS_COMPILE=$CROSSCOMPILER/bin/arm-linux-gnueabihf- -sysroot $ROOTFS -opensource -confirm-license -optimized-qmake -release -qt-pcre -make libs -prefix $QT5PIPREFIX -hostprefix $QT5PIHOSTPREFIX"

	if [ ! -f /etc/redhat-release ]
	then
		CONFIGURE_OPTIONS="$CONFIGURE_OPTIONS -reduce-exports"
        echo "got to the reduce exports"
	fi
